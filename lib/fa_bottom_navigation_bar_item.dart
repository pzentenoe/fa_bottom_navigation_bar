...
class FaBottomNavigationBarItem extends StatelessWidget {
  final String label;
  ...
  int index;
  int selectedIndex;
  FaBottomNavigationBarTheme theme;
    ...
    return CircleAvatar(
      ...
      child: SizedBox(
        ...
        child: CircleAvatar(
          ...
          child: _makeIcon(iconData, isFaIcon),
        ),
      ),
    );
  }

  Widget _makeIcon(IconData iconData, bool isFaIcon) {
    bool isSelected = _isItemSelected();
    if (isFaIcon) {
      return FaIcon(
        iconData,
  ...
  Widget build(BuildContext context) {
    theme = Provider.of<FaBottomNavigationBarTheme>(context);
